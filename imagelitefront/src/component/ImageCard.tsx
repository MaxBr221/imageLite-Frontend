...
export const ImageCard: React.FC<ImageCardProps> = (props: ImageCardProps) =>{
    ...
    return(
        ...
        <div className="card relative bg-white rounded-md shadow-md transation-tranform ease-in duration-300 transform hover: shadow-lg hover:-translate-y-2">
            ...
            <div className="card-body p-4">
                ...
                <p className="text-gray-600 ">{formatBytes(props.tamanho, 2)}</p>
